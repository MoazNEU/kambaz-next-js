...
export default function Lab1() {
    return (
      <div id="wd-lab1">
        <h2>Moaz Ghulman, Section 2 Online</h2>
        <h2>My Github link is provided in the end of this page too!</h2>
        <h2>Lab 1</h2>
        <h3>HTML Examples</h3>
        <div id="wd-h-tag">
          <h4>Heading Tags</h4>
  ...
  tell browsers to render the gaps.
        ...
        <div id="wd-lists">
          ...
          <ol id="wd-your-favorite-recipe">
            ...
            <li>Stir bowl</li>
            <li>Pour bowl into stove plate</li>
        ...
        <div id="wd-forms">
          ...
          <form id="wd-text-fields">
            ...
            Please 
            <a href="https://github.com/MoazNEU" id="wd-github">click here</a>
             to get my github account<br/>
          </form>
        </div>
